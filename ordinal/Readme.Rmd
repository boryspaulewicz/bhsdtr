...
let's take a look at participant-specific delta estimates in the SDT
model:
...
the *average* pattern of the thresholds seems to be different
...
large samples, because estimates of sample average item-parameters
