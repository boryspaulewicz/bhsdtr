...
% Software implementation relies on ready-made model specifications
% expressed in JAGS language that are aimed at several simple types of
% experimental design (e.g., single subject or single group of
% subjects). The models can be fitted using convenient MATLAB
% functions.
